...
const searchFun = () => {
    ...
    if (visibleCount > 0) {
        moviesContainer.style.alignitems = "center"; // Align to the left if there are visible items
        moviesContainer.style.marginLeft = ""; // Adjust this value as needed
    } else {
        moviesContainer.style.alignitems  = "center"; // Center if no items are visible
